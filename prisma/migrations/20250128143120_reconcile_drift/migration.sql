...
-- CreateIndex
CREATE UNIQUE INDEX "profile_profileId_key" ON "public"."profile"("profileId");
...
-- AddForeignKey
ALTER TABLE "public"."Listing" ADD CONSTRAINT "Listing_providerId_fkey" FOREIGN KEY ("providerId") REFERENCES "public"."profile"("profileId") ON DELETE RESTRICT ON UPDATE CASCADE;
